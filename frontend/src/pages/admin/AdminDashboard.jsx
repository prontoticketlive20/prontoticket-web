...
<button
  ...
  className="flex items-center gap-2 px-3 py-2 rounded-xl bg-gradient-to-r from-[#5856D6] to-[#3634A3] text-white font-semibold shadow-lg shadow-[#5856D6]/20 hover:brightness-110 active:scale-[0.99]"
  type="button"
>
  <Users size={16} />
