...
<div className="rounded-2xl border border-blue-500/20 bg-blue-500/5 p-5">
  <div className="flex items-center gap-2 mb-4">
    ...
    <div className="text-white font-semibold">Distribución Global del Evento 🌎</div>
  </div>
  ...
  {/* 🔥 SOLO SE MUESTRA SI YA EXISTE EVENTO */}
  {successMsg ? (
    <DistributionPanel eventId={null} />
  ) : (
    <div className="text-xs text-yellow-400">
      Debes crear el evento primero para habilitar la distribución.
    </div>
  )}
</div>
